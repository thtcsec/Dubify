...
:: Start Backend
start cmd /k "echo Starting Backend... && cd backend && if exist .venv\Scripts\activate ( .venv\Scripts\activate && uvicorn app.main:app --reload ) else ( echo ERROR: Virtual environment not found! && pause )"
